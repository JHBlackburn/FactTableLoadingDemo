/*
Deployment script for FactTableLoading
...
GO
:setvar DatabaseName "FactTableLoading"
:setvar DefaultFilePrefix "FactTableLoading"
...
GO
PRINT N'Creating [OLTP].[AccountBillingType]...';
...
CREATE TABLE [OLTP].[AccountBillingType] (
    ...
    PRIMARY KEY CLUSTERED ([AccountBillingTypeID] ASC)
);


GO
PRINT N'Creating [Stage].[FactAccountBillingType]...';
...
GO
PRINT N'Creating [dbo].[DimBillingType]...';


GO
CREATE TABLE [dbo].[DimBillingType] (
...
GO
PRINT N'Creating [dbo].[FactAccountBillingType]...';
